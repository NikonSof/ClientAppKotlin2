...
class KanBoard : AppCompatActivity(), TasklistFragment.Callbacks {
    private lateinit var viewPager: ViewPager2
    private lateinit var tabLayout: TabLayout

    private lateinit var taskViewModel: TaskViewModel

    // Когда кнопка добавления нажата из action bar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kan_board)
    ...
    private fun writeViewModelToSharedPrefs(){
        ...
        //Конвертация листов в JSON строки
